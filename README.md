...
![AFR_BR_Scatter_plot](https://github.com/chimaobi-okite/Benchmark_Improve_LLM_Robustness_in_Personalization/blob/main/paper_images/AFR_BR_Scatter_plot.png?raw=true)
...
![llama_pref_setting](https://github.com/chimaobi-okite/Benchmark_Improve_LLM_Robustness_in_Personalization/blob/main/paper_images/llama_pref_setting.png?raw=true)

**Answer: Irrelevant preferences amplify robustness errors.** 

**Q: What types of failure patterns do models exhibit?**

![failure causes](https://github.com/chimaobi-okite/Benchmark_Improve_LLM_Robustness_in_Personalization/blob/main/paper_images/failure_causes.png?raw=true)
...
![pref_aligner](https://github.com/chimaobi-okite/Benchmark_Improve_LLM_Robustness_in_Personalization/blob/main/paper_images/pref_aligner.png?raw=true)
